...
*  Answer: CRC
*
*  Reset wifi configuration: 8266 0 00 000 00 00 00000
*/
...
void SearchPrefixZeroMess(); //Search prefix Zero mess in buffer
...
/*
*  Search and set data from Prefix Zero mess
*/
void SearchPrefixZeroMess()
{
	if (g_aInMessData[4] == 0)
	{
