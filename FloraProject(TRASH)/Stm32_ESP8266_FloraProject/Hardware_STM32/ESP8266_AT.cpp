...
*  OutPut: Last symbol string position or Not Found(513)
*/
int ESP8266_SearchStringBufferWithPos(char* SearchTwoSymb, int StartSearchPos)
{
...
*  Output: Symbol position or ERROR(513)
*/
int ESP8266_SearchSymbolBufferWithPos(char SearchSymb, int StartSearchPos)
{
